...
const Trending = () => {
	...
	const options = {
		...
		headers: {
			...
			Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyZWE2MDQ4YWI3NmIxYjkwMmUxYmFhMjU3OTMwOTIwZSIsInN1YiI6IjY0ZWE0NTBkYzVjMWVmMDBjNjUyMzlmNyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.bjFaJlSZLNNxQlXL60ErAoWBGViouXFNI8M8yycorgU",
		},
	};
